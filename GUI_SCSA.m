...
%% positive datsets
Reconstruct_positive_signals
spectre1=temp3;
%% negative datsets
Reconstruct_negative_signals
spectre2=temp3;
%% plot the spectrums
Plot_the_spectrum_features
...
function MSE_a2_Callback(hObject, eventdata, handles)
% hObject    handle to MSE_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSE_a2 as text
%        str2double(get(hObject,'String')) returns contents of MSE_a2 as a double


% --- Executes during object creation, after setting all properties.
function MSE_a2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSE_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Load_datas_Callback(hObject, eventdata, handles)
% hObject    handle to Load_datas (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function h_a2_Callback(hObject, eventdata, handles)
% hObject    handle to h_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of h_a2 as text
%        str2double(get(hObject,'String')) returns contents of h_a2 as a double


% --- Executes during object creation, after setting all properties.
function h_a2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to h_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function N_a2_Callback(hObject, eventdata, handles)
% hObject    handle to N_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of N_a2 as text
%        str2double(get(hObject,'String')) returns contents of N_a2 as a double


% --- Executes during object creation, after setting all properties.
function N_a2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to N_a2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Sensitiv_Callback(hObject, eventdata, handles)
% hObject    handle to Sensitiv (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Sensitiv as text
%        str2double(get(hObject,'String')) returns contents of Sensitiv as a double


% --- Executes during object creation, after setting all properties.
function Sensitiv_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Sensitiv (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Specific_Callback(hObject, eventdata, handles)
% hObject    handle to Specific (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Specific as text
%        str2double(get(hObject,'String')) returns contents of Specific as a double


% --- Executes during object creation, after setting all properties.
function Specific_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Specific (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function accurc_Callback(hObject, eventdata, handles)
% hObject    handle to accurc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of accurc as text
%        str2double(get(hObject,'String')) returns contents of accurc as a double


% --- Executes during object creation, after setting all properties.
function accurc_CreateFcn(hObject, eventdata, handles)
% hObject    handle to accurc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function N_folds_Callback(hObject, eventdata, handles)
% hObject    handle to N_folds (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of N_folds as text
%        str2double(get(hObject,'String')) returns contents of N_folds as a double
