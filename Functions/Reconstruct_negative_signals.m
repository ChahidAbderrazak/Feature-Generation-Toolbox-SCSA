...
%     set(handles.nb_eig,'string', sz_indx-1);
 ...
 set(handles.disp_Nh2,'string', msg22);
 
% render the tablee
set(handles.t2,'data',d);
...
set(handles.h_a2,'string',num2str(floor(h))) ;
...
%                 ylabel('Signal')
                grid on                
                title( 'Negative signal reconstruction using SCSA')
...
set(handles.N_a2,'string', SCSA_Dw_fs );
set(handles.MSE_a2,'string', MSE );
set(handles.MSE_a2,'string', sprintf('%.1e',MSE) );
